...
#pragma warning disable CS8604 // Possible null reference argument.
        configMenu.AddTextOption(ModManifest,
            ...
            {
                "Cursor" => i18n.Get("config.DetectionMethod.cursor"),
                "Player" => i18n.Get("config.DetectionMethod.player"),
                "Cursor ONLY" => i18n.Get("config.DetectionMethod.cursorOnly"),
                _ => null,
            },
...
#pragma warning disable CS8604 // Possible null reference argument.
        configMenu.AddTextOption(ModManifest,
            ...
            formatAllowedValue: val => val switch
            {
                ...
                "None" => i18n.Get("config.KegsAndJar.none"),
                "Fruit" => i18n.Get("config.KegsAndJar.fruit"),
                "Vegetable" => i18n.Get("config.KegsAndJar.vegetable"),
                "Both" => i18n.Get("config.KegsAndJar.both"),
                _ => null
...
#pragma warning disable CS8604 // Possible null reference argument.
        configMenu.AddTextOption(ModManifest,
            ...
            formatAllowedValue: val => val switch
            {
                ...
                "None" => i18n.Get("config.KegsAndJar.none"),
                "Fruit" => i18n.Get("config.KegsAndJar.fruit"),
                "Mushroom" => i18n.Get("config.KegsAndJar.mushroom"),
                "Both" => i18n.Get("config.KegsAndJar.both"),
                _ => null,
